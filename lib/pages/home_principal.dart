...
import 'package:main_app_flutter/widgets/task_group.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    if (now != null) {
      ...
      // Handle the case where now is null
          ...
          return AlertDialog(
            content: SingleChildScrollView(
              child: ListBody(
                children: <Widget>[
                  GestureDetector(
                    child: Text('Agregar Apuntes por Camara'),
                    onTap: () {
                  ...
                  GestureDetector(
                    child: new Text('Agregar apuntes por galeria'),
                    onTap: () {
                      Navigator.pushNamed(context, Routes.todaysTask);
                    },
                  ),
