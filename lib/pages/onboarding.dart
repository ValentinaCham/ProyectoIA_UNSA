...
class _BoardingWidget extends StatefulWidget {
  const _BoardingWidget({
    Key? key,
  }) : super(key: key);

  @override
  State<_BoardingWidget> createState() => _BoardingWidgetState();
}

class _BoardingWidgetState extends State<_BoardingWidget> {
  @override
  void dispose() {
...
class _BoardingWidget2 extends StatefulWidget {
  const _BoardingWidget2({
    Key? key,
  }) : super(key: key);

  @override
  State<_BoardingWidget2> createState() => _BoardingWidget2State();
}

class _BoardingWidget2State extends State<_BoardingWidget2> {
  @override
  void dispose() {
    // Clean up resources, cancel subscriptions, etc.
    // This method is called when the widget is removed from the widget tree.
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Prueba para ver el cambio de página.",
            textAlign: TextAlign.center,
            style: TextStyle(
              color: Colors.grey[500],
              fontSize: 16,
